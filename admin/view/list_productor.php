...
if (!defined('PATH_SYSTEM')) die ('Bad Request');
        ...
        $stmt = $conn->prepare("SELECT count(id) as total FROM PRODUCTOR ");
        $stmt->execute();
        ...
        try
        {
            $stmt = $conn->prepare("SELECT * FROM PRODUCTOR LIMIT $start,$limit");
            ...
            <div class="block">
                <table style="width:100%"> 
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?c=view&a=editproductor&id=<?php echo $data['id'] ?>">
                            <?php
                                echo $data['name'];
                            ?>
                            </a>
                        ...
                        <td><a href="?c=productor&a=delete&id=<?php echo $data['id'] ?>"><b>Xóa</b></a></td>
                    </tr>
                    <?php }?>
                </table>

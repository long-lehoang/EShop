...
if (!defined('PATH_SYSTEM')) die ('Bad Request');
        ...
        $stmt = $conn->prepare("SELECT count(id) as total FROM PAYMENT WHERE status='Chờ Xác Nhận' ");
        $stmt->execute();
        ...
        try
        {
            ...
            $stmt = $conn->prepare("SELECT * FROM PAYMENT WHERE status='Chờ Xác Nhận' ORDER BY time LIMIT $start,$limit");
